...
import PaidAdsImage from '../assets/images/PaidAdsImages.png?react';
import WebDevImage from '../assets/images/APIIntegrations.png?react';
import DigitalMarketingImage from '../assets/images/DigitalMarketing.png?react';
import StrategyConsultingImage from '../assets/images/consulting.png?react';
import APIIntegrationImage from '../assets/images/AllTogether.png?react';
...
const Services = () => {
  ...
  return (
    <div className="main-wrapper min-h-screen bg-gradient-to-br from-[#f7faff] to-[#d1d7e0] dark:bg-gradient-to-b dark:from-[#332940] dark:to-[#0f0c29] text-dark-primary dark:text-light-text font-gothic">
      ...
      <section className="py-20 bg-gradient-to-br from-[#460696] to-[#ff5e62] text-dark-text">
        <div className="text-center mb-12">
