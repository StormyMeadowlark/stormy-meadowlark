  ...
  <div className="bg-light-primary dark:bg-dark-primary text-light-text dark:text-light min-h-screen font-gothic">
    ...
    */}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        At Stormy Meadowlark, we create web solutions that are as unique as your business. From visually stunning, mobile-first websites to custom-built applications, we empower your brand with tools designed for growth. Our designs ensure seamless experiences across mobile phones and larger screens, combining functionality with style. Whether you're a local shop or an established enterprise, our custom-built solutions and thoughtful strategies help your business stand out in today’s digital world.
        </p>
        <Link
          to="/contact"
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            We recognize that every business is unique, and your website should be too. That’s why we focus on delivering:
            </p>
            <ul className="text-xl leading-relaxed list-disc list-inside">
              <li><b>Mobile-first designs</b> that look stunning and function seamlessly on any device.</li>
              <li><b>Custom-built solutions</b> tailored to your specific goals and audience.</li>
              <li><b>SEO-driven strategies</b> to enhance visibility and search rankings.</li>
              <li><b>Scalable applications</b> for businesses needing advanced features or integrations.</li>
            </ul>
            <div className="text-xl leading-relaxed my-8">We don’t just build websites—we create tools for growth that evolve with your business.</div>
          </div>
          <div>
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          When HEM Automotive partnered with Stormy Meadowlark, they needed a professional online presence to showcase their 11 core services and build visibility. We delivered:
          </p>
          <ul className="text-xl leading-relaxed list-disc list-inside text-left">
            <li>A sleek, mobile-first website tailored to highlight their services effectively..</li>
            <li>A future-ready platform designed to integrate tools like appointment booking, customer education, and a sales system.</li>
            <li>SEO strategies to create a solid foundation for online growth.</li>
          </ul>
          <p className="text-xl leading-relaxed mt-8 text-left">
          Today, HEM Automotive has a modern, professional site, laying the groundwork for increased customer engagement and advanced features in the future.
          </p>
        </div>
      </div>
    </motion.section>
    ...
    */}
    ...
    >
      ...
      When it comes to building your shop’s online presence, both custom websites and template-based solutions have their place. Here’s how they differ:
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          ...
          />
          <p className="text-xl leading-relaxed text-left"><b>
            Truly Custom Websites
            </b>
            <ul className='list-disc list-inside'>
              <li>
              Built from scratch to match your brand, audience, and specific needs.
              </li>
              <li>
              Fully scalable, offering integrations like appointment booking and customer portals.
              </li>
              <li>
              A long-term investment that evolves with your business.
              </li>
            </ul>
          </p>
        </div>
        <div>
          ...
          <p className="text-xl leading-relaxed text-left"><b>
            ...
            <ul className='list-disc list-inside'>
              <li>
              Faster to launch and budget-friendly.
              </li>
              <li>
              Pre-designed layouts offer a starting point for smaller shops or those new to digital marketing.
              </li>
              <li>
              Limited flexibility for scaling or advanced features.
              </li>
            </ul>
          </p>
        </div>
      ...
      At Stormy Meadowlark, we help you decide what’s best for your shop—whether starting with a template or investing in a fully custom build. The choice depends on where you are now and where you want to go.
      </div>
    </motion.section>
    </div>
    ...
    */}
    ...
    >
      ...
      At Stormy Meadowlark, we believe building a website is a collaboration, not just a project. From brainstorming ideas to the final launch, we’re with you every step of the way. Together, we’ll create a site that captures your shop’s personality, engages your customers, and sets you up for growth. Whether it’s planning, designing, or testing, every decision is made with your goals in mind to deliver a website that works as hard as you do.
      </p>
    </motion.section>
      ...
      */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        <div>
          ...
          we use tools built for busy shop owners who need reliability and performance.
          </p>
          <ul className="list-disc list-inside text-left mb-4 text-xl">
            <li>React & Firebase: Fast-loading, responsive websites that work perfectly across devices.</li>
            <li>Node.js & Express: Ensuring smooth and powerful back-end functionality.</li>
            <li>MongoDB: Keeping your data organized and accessible.</li>
            <li>Tailwind CSS: Delivering designs that look sharp and modern.</li>
            <li>Docker & Kubernetes: (Coming Soon) Optimizing speed and scalability for your site’s future growth.</li>
          </ul>
          <p className="text-md italic">
          We choose these tools to create solutions that are as hardworking as your business.
          </p>
        </div>
        ...
        */}
        <div>
          <h3 className="text-2xl font-bold mb-4">Timeline for a Custom Website</h3>
          <p className="text-xl leading-relaxed mb-4">
          A truly custom website, built from the ground up, requires time and care to reflect your shop’s unique identity and goals. Here’s a realistic timeline for our most expensive package:
          </p>
          <ul className="list-disc list-inside text-left mb-4 text-xl">
            <li><b>Discovery & Strategy (4–6 weeks):</b> Defining goals, researching your audience, and setting the project’s foundation.</li>
            <li><b>Design Phase (6–8 weeks):</b> Creating wireframes, mockups, and visuals tailored to your brand.</li>
            <li><b>Content Creation (6–8 weeks): Developing custom images, videos, and SEO-driven text.</b></li>
            <li><b>Development (10–12 weeks):</b> Building, testing, and refining your site for seamless functionality.</li>
            <li><b>Content Integration (2-3 weeks):</b> Optimize the site with text, images, and videos.</li>
            <li><b>Pre-Launch Testing (2–3 weeks):</b>Compatibility testing, SEO metadata and site maps, debugging and revisions</li>
            <li><b>Launch (3–4 weeks):</b> Final reviews, deployment, training sessions, final tweaks</li>
            <li><b>Post-Launch Optimization (4–6 weeks, optional)</b>Review analytics to track user engagment, implement updates, provide ongoing support and maintenance.</li>
          </ul>
          <p className="text-md italic">
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          These tools are part of our vision to take your website to the next level, tailored for businesses ready to scale.
          </p>
        </div>
        <div>
          <img
    ...
    */}
    ...
    >
      ...
      From simple landing pages for lead generation to fully custom digital platforms, Stormy Meadowlark delivers solutions tailored to your shop’s growth.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12">
        ...
        <div className="p-8 bg-white dark:bg-dark-secondary rounded-lg shadow-lg">
          ...
          <p className="text-md font-semibold mb-2">
            ...
            <span className="text-sm italic">Security updates and small content tweaks.</span>
          </p>
          <p className="italic text-gray-500 dark:text-dark-text">Perfect for creating an immediate online presence that drives action.</p>
        </div>

        {/* Package 2: Growth Starter (<= $1000) */}
        <div className="p-8 bg-white dark:bg-dark-secondary rounded-lg shadow-lg">
          <h3 className="text-2xl font-bold text-accent mb-4">Starter Package</h3>
          <p className="text-3xl font-extrabold mb-4 text-accent">$750</p>
          <ul className="list-disc list-inside text-left mb-4">
            <li>Up to 3 pages with custom mobile-first design</li>
            <li>SEO setup and local listings for better search visibility.</li>
          </ul>
          <p className="text-md font-semibold mb-2">
            Maintenance: $30/month<br />
            <span className="text-sm italic">
            Regular updates, monitoring, and security.</span>
          </p>
          <p className="italic text-gray-500 dark:text-dark-text">Ideal for small shops starting to establish their digital presence.</p>
        </div>
        ...
        <div className="p-8 bg-white dark:bg-dark-secondary rounded-lg shadow-lg">
          ...
          <ul className="list-disc list-inside text-left mb-4">
            ...
            <li>On-page SEO and basic analytics setup to track performance.</li>
          </ul>
          <p className="text-md font-semibold mb-2">
            <span className="underline">After 2 years:</span> $50/month maintenance <br />
            <span className="text-sm italic">Comprehensive updates and support.</span>
          </p>
          <p className="italic text-gray-500 dark:text-dark-text">Designed for growing businesses looking to stand out.</p>
        </div>
        ...
        <div className="p-8 bg-white dark:bg-dark-secondary rounded-lg shadow-lg">
          ...
          <p className="text-md font-semibold mb-2">
            ...
            <span className="text-sm italic">Advanced security, updates, and patches.</span>
          </p>
          <p className="italic text-gray-500 dark:text-dark-text">Great for businesses expanding their online capabilities.</p>
        </div>
        ...
        <div className="p-8 bg-white dark:bg-dark-secondary rounded-lg shadow-lg">
          ...
          <ul className="list-disc list-inside text-left mb-4">
            <li>10+ pages with advanced integrations (e.g., CRM, analytics, phone).</li>
            <li>Comprehensive SEO, ongoing optimization, and security enhancements.</li>
          </ul>
          <p className="text-md font-semibold mb-2">
          ...
          <p className="italic text-gray-500 dark:text-dark-text">For businesses ready for a scalable, feature-rich solution.</p>
        </div>

        {/* Package 6: Custom Full-Stack (> $1000) */}
        <div className="p-8 bg-white dark:bg-dark-secondary rounded-lg shadow-lg">
          <h3 className="text-2xl font-bold text-accent mb-4">Custom Full-Stack Development</h3>
          <p className="text-3xl font-extrabold mb-4 text-accent">
          ...
          <p className="italic text-gray-500 dark:text-dark-text">Built for businesses ready to invest in a fully customized digital ecosystem.</p>
        </div>
      </div>
