  ...
  return (
    <div className="bg-light dark:bg-dark-primary text-dark dark:text-dark-text min-h-screen py-20">
      <div className="container mx-auto">
        ...
        >
          <h1 className="text-5xl font-heading mb-4">Stormy Meadowlark Blog</h1>
        ...
        >
          <input
            ...
            className="w-full p-4 rounded-lg shadow-md bg-white dark:bg-dark-secondary text-dark dark:text-light"
          />
        </motion.div>
        ...
        >
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-white ${selectedTag === tag ? 'bg-indigo-500 dark:bg-accent' : 'bg-gray-500 dark:bg-dark-primary hover:bg-indigo-500 dark:hover:bg-accent'}`}
            >
              {tag}
            </button>
          ))}
          <button
            ...
            className="px-4 py-2 rounded-full text-white bg-gray-500 dark:bg-dark-primary hover:bg-indigo-500 dark:hover:bg-accent"
          >
            All
          </button>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {filteredPosts.map((post) => (
            <motion.div
              key={post.id}
              className="p-6 bg-white dark:bg-dark-secondary rounded-lg shadow-md"
            ...
            >
              ...
              <Link
                to={post.url}
                className="text-indigo-500 dark:text-accent mt-4 inline-block"
              >
                Read More
              </Link>
            </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 bg-indigo-500 dark:bg-dark-accent text-white rounded-lg shadow-md">
            ...
            <div className="p-6 bg-indigo-500 dark:bg-dark-accent text-white rounded-lg shadow-md">
              <h3 className="text-2xl font-heading mb-4">One More Post</h3>
              <p className="text-lg mb-4">
        ...
        <motion.section
          className="bg-gray-100 dark:bg-dark-secondary py-16 rounded-lg shadow-md"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="max-w-lg mx-auto">
            <input
              ...
              className="w-full p-4 rounded-lg shadow-md bg-white dark:bg-dark-primary text-dark dark:text-light mb-4"
            />
            <button className="w-full bg-indigo-500 dark:bg-accent text-white font-bold py-3 px-6 rounded-lg shadow-md hover:bg-indigo-600 dark:hover:bg-accent-dark">
              Subscribe
            </button>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              />
              <h3 className="text-2xl font-heading">Alex Johnson</h3>
            ...
            <div className="text-center">
              <img
                ...
                className="w-32 h-32 rounded-full mx-auto mb-4"
              />
              <h3 className="text-2xl font-heading">Taylor Smith</h3>
            ...
            <div className="text-center">
              <img
                ...
                className="w-32 h-32 rounded-full mx-auto mb-4"
              />
              <h3 className="text-2xl font-heading">Jordan Brown</h3>
        ...
        >
          ...
          <Link
            to="/contact"
            className="bg-indigo-500 dark:bg-accent text-white font-bold py-3 px-6 rounded-full transition-colors hover:bg-indigo-600 dark:hover:bg-accent-dark"
          >
            Get in Touch
          </Link>
        </motion.section>
